...
<template>
	<!-- <div class="modal-backdrop font-display antialiased">
		<div
			class="bg-white border border-orange rounded-md shadow-base w-5/12"
			role="dialog"
	...
	<div class="modal-backdrop">
		<div class="flex justify-center my-2 mx-4 md:mx-0 font-display text-orange">
			<form
				class="w-full max-w-xl bg-white rounded-lg shadow-md p-6 border border-orange"
			>
				<div class="text-center relative">
					<slot name="header">
						<button
							type="button"
							class="btn-close absolute right-0 top-0"
							@click="close"
							aria-label="Close modal"
						>
							x
				...
				<div class="flex flex-wrap -mx-3 mb-6">
					...
					<div class="flex items-center w-full mt-2">
						<div
							class="w-full md:w-1/3 px-3 pt-4 mx-2 border-t border-gray-400"
						>
							<button
